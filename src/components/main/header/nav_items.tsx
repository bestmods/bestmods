export const NavItems: React.FC<{
    ...
    return (
        <>
            ...
            <a rel="noreferrer" className={classes ? classes : "text-gray-300 hover:text-white"} href="https://github.com/bestmods/bestmods/milestones" target="_blank">Roadmap</a>
            ...
            <a rel="noreferrer" className={classes ? classes : "text-gray-300 hover:text-white"} href="https://github.com/orgs/bestmods/discussions/35" target="_blank">Removals</a>
