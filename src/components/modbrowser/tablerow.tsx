...
const TableRow: React.FC<{ mod: any, addClasses: string, banner: string, descShort: string, dots: string, cat: any, catPar?: Category | null, catParIcon: string, catParLink: string | null, catIcon: string, catLink: string | null,  viewLink: string }> = ({ mod, addClasses, banner, descShort, dots, cat, catPar, catParIcon, catParLink, catIcon, catLink, viewLink }) => {
    ...
    return (
        <div key={mod.id} className={"w-full h-32 my-5 rounded bg-gradient-to-b from-cyan-800 to-cyan-900 flex shadow-lg justify-center items-center" + addClasses}>
            <div className="h-full">
                <img className="w-full h-full max-h-full rounded-l" src={banner} alt="Mod Banner" />
            ...
            <div className="ml-8 mr-8 mb-4 max-h-24 grow overflow-hidden text-ellipsis">
            ...
            {catPar != null && (
                <div className="ml-8 mr-8 mb-1 text-white flex">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="mr-2 w-1/5 flex justify-end items-end flex-col">
