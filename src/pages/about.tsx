                        ...
                        >
                            <div className="flex flex-col gap-2">
                                <FAQ
                                    ...
                                    answer={
                                        <>
                                            ...
                                            <p>The decision to use a web scraper is something we{"'"}ve thought about for close to a year given web scraping is generally frowned upon. However, after receiving feedback from multiple mod creators and the fact that we direct all download links back to the original source, we{"'"}ve decided to create and utilize a web scraper to give our users more mods to choose from. Additionally, we only web scrape <span className="font-bold">public information</span> from our list of mod sources which is currently <Link href="https://blog.apify.com/is-web-scraping-legal/" target="_blank">legal</Link> in the United States. We also follow each mod source website{"'"}s <span className="font-bold">robots.txt</span> file to ensure we aren{"'"}t web scraping data that shouldn{"'"}t be web scraped.</p>
                                            <p>With that said, if you do not want your mods or sources listed on our website, you may request a removal of your content. To do so, please read the <span className="font-bold">I do not want my mods or sources listed on this website. Can I remove them?</span> question below.</p>
                                ...
                                <FAQ
                                    ...
                                    answer={
                                        <>
                                            <p>Of course! If you want your mod(s) and content removed from our website, you may file a request through our website <Link href="https://moddingcommunity.com/forum/259-removal-requests/" target="_blank">here</Link>. Alternatively, you may email us at <EmailLink /> or reach out to a contributor or admin directly.</p>
