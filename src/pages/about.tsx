            ...
            <Main>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-2 flex flex-col gap-4">
                        <Section title="About">
                            <p><Link href="/" className="font-bold">Best Mods</Link> is an index for game mods where users can browse and find mods from multiple sources on the Internet! Our goal is to allow users to discover all mods in one place.</p>
                        ...
                        >
                            <div className="flex flex-col gap-2">
                                <FAQ
                                    ...
                                    answer={
                                        <>
                                            <p>Mods are currently added manually or through our web scraper. All details including download links are directed back to the website(s) where the mod originated from.</p>
                                ...
                                <FAQ
                                    ...
                                    answer={
                                        <>
                                            <p>Of course! If you want your mods and content removed from Best Mods, you may file a request through our GitHub repository <Link href="https://github.com/orgs/bestmods/discussions/35" target="_blank">here</Link>. Alternatively, you may email us @ <Link href="mailto:bestmods.business@gmail.com" className="italic">bestmods.business@gmail.com</Link></p>
                                ...
                                <FAQ
                                    ...
                                    answer={
                                        <>
                                            <p>Users who have the Contributor role or higher can edit each mod&apos;s details including images, description, installation, sources, download links, and more. We would recommend reaching out to a contributor or emailing us @  <Link href="mailto:bestmods.business@gmail.com" className="italic">bestmods.business@gmail.com</Link> to request an update.</p>
                                            <p>In the future, we plan to implement a change request form users may use to request an information update on specific mods.</p>
                                        </>
                                    }
                                />
                            </div>
